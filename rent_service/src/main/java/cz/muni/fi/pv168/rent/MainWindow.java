...
public class MainWindow extends javax.swing.JFrame {
    ...
    public MainWindow(DataSource dataSource) {                               
        ...
        manager.getCustomerManager().createCustomer(customer1);
        manager.getCustomerManager().createCustomer(customer2);
        ...
        manager.getVehicleManager().createVehicle(vehicle1);
        manager.getVehicleManager().createVehicle(vehicle2);
        */
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
            ...
            @Override
            protected void done() {
                JOptionPane.showMessageDialog(null, custModel.bundle.getString("OpCompleted"), 
                        custModel.bundle.getString("Warning"), JOptionPane.WARNING_MESSAGE);
            }
        };
        worker.execute();
